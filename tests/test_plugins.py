...
def test_urls_must_be_http():
    ...
    with pytest.raises(ValidationError, match="http"):
        PluginSpec(**_spec_kwargs(repository="git@github.com:tai42ai/tai-toolbox.git"))
...
def test_http_urls_are_accepted_for_homepage_and_repository():
    ...
    assert (
        PluginSpec(**_spec_kwargs(repository="http://github.com/tai42ai/tai-toolbox")).repository
        == "http://github.com/tai42ai/tai-toolbox"
    )
