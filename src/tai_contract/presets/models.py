...
:meth:`~tai_contract.presets.PresetStore.save_version`) lives in the skeleton,
...
class PresetBody(BaseModel):
    ...
    per-version :attr:`~tai_contract.versioning.DocumentVersion.tags`.
...
class CarryForward:
    """Sentinel for a :meth:`~tai_contract.presets.PresetStore.save_version`
