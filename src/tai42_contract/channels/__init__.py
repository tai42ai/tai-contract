...
from tai42_contract.interactions.models import AnswerFormat
...
class Channel(Protocol):
    ...
    async def notify(self, notification: ChannelNotification) -> None:
        ...
        a bad send response — raises :class:`ChannelDeliveryError`; a plain
...
__all__ = ["Channel", "ChannelDelivery", "ChannelDeliveryError", "ChannelNotification"]
